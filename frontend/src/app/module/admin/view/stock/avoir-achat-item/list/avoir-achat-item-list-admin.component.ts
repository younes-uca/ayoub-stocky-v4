...
export class AvoirAchatItemListAdminComponent extends AbstractListController<AvoirAchatItemDto, AvoirAchatItemCriteria, AvoirAchatItemAdminService>  implements OnInit {
    ...
    constructor( private avoirAchatItemService: AvoirAchatItemAdminService  , private depotService: DepotAdminService, private taxeService: TaxeAdminService, private avoirAchatService: AvoirAchatAdminService, private produitService: ProduitAdminService) {
