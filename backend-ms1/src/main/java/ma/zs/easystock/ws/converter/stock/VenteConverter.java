...
public class VenteConverter extends AbstractConverter<Vente, VenteDto> {
    ...
    public  VenteConverter(){//EtatAvoirVente etatAvoirVenteAvoirVenteItem avoirVenteItemEntrepriseSociete entrepriseSocieteEtatVente etatVenteDepot depotVenteItem venteItemReglementVente reglementVenteModeReglement modeReglementClient clientAvoirVente avoirVenteTaxe taxeProduit produit){
