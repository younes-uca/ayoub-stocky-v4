...
export class BonPourViewAdminComponent extends AbstractViewController<BonPourDto, BonPourCriteria, BonPourAdminService> implements OnInit {
    ...
    constructor(private bonPourService: BonPourAdminService, private taxeService: TaxeAdminService, private bonPourItemService: BonPourItemAdminService, private produitService: ProduitAdminService, private clientService: ClientAdminService){
