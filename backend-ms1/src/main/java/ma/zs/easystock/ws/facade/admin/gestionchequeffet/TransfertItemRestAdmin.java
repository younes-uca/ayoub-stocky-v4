...
public class TransfertItemRestAdmin  extends AbstractController<TransfertItem, TransfertItemDto, TransfertItemCriteria, TransfertItemAdminService, TransfertItemConverter> {
    ...
    @Operation(summary = "find by fromDepot id")
    @GetMapping("fromDepot/id/{id}")
    public List<TransfertItemDto> findByFromDepotId(@PathVariable Long id){
        return findDtos(service.findByFromDepotId(id));
    }
    @Operation(summary = "delete by fromDepot id")
    @DeleteMapping("fromDepot/id/{id}")
    public int deleteByFromDepotId(@PathVariable Long id){
        return service.deleteByFromDepotId(id);
    }
    @Operation(summary = "find by toDepot id")
    @GetMapping("toDepot/id/{id}")
    public List<TransfertItemDto> findByToDepotId(@PathVariable Long id){
        return findDtos(service.findByToDepotId(id));
    }
    @Operation(summary = "delete by toDepot id")
    @DeleteMapping("toDepot/id/{id}")
    public int deleteByToDepotId(@PathVariable Long id){
        return service.deleteByToDepotId(id);
    }
