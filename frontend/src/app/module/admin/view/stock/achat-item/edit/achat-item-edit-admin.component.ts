...
export class AchatItemEditAdminComponent extends AbstractEditController<AchatItemDto, AchatItemCriteria, AchatItemAdminService>   implements OnInit {
    ...
    private _validAchatItemEntrepriseSociete = true;
    ...
    constructor( private achatItemService: AchatItemAdminService , private achatService: AchatAdminService, private depotService: DepotAdminService, private taxeService: TaxeAdminService, private entrepriseSocieteService: EntrepriseSocieteAdminService, private produitService: ProduitAdminService) {
    ...
    public setValidation(value: boolean){
        ...
        this.validAchatItemEntrepriseSociete = value;
    ...
    public validateForm(): void{
        ...
        this.validateAchatItemEntrepriseSociete();
    ...
    public validateAchatItemEntrepriseSociete(){
        if (this.stringUtilService.isEmpty(this.item.entrepriseSociete)) {
            this.errorMessages.push('Entreprise societe non valide');
            this.validAchatItemEntrepriseSociete = false;
        } else {
            this.validAchatItemEntrepriseSociete = true;
        }
    }
  ...
  set createEntrepriseSocieteDialog(value: boolean) {
    ...
    get validAchatItemEntrepriseSociete(): boolean {
        return this._validAchatItemEntrepriseSociete;
    }
    set validAchatItemEntrepriseSociete(value: boolean) {
        this._validAchatItemEntrepriseSociete = value;
    }
