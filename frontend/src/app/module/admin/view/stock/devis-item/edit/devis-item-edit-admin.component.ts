...
export class DevisItemEditAdminComponent extends AbstractEditController<DevisItemDto, DevisItemCriteria, DevisItemAdminService>   implements OnInit {
    ...
    constructor( private devisItemService: DevisItemAdminService , private taxeService: TaxeAdminService, private produitService: ProduitAdminService, private devisService: DevisAdminService) {
