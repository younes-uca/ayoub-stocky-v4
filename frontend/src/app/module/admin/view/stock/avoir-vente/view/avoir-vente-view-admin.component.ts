...
export class AvoirVenteViewAdminComponent extends AbstractViewController<AvoirVenteDto, AvoirVenteCriteria, AvoirVenteAdminService> implements OnInit {
    ...
    constructor(private avoirVenteService: AvoirVenteAdminService, private depotService: DepotAdminService, private etatAvoirVenteService: EtatAvoirVenteAdminService, private taxeService: TaxeAdminService, private avoirVenteItemService: AvoirVenteItemAdminService, private entrepriseSocieteService: EntrepriseSocieteAdminService, private produitService: ProduitAdminService, private venteService: VenteAdminService, private clientService: ClientAdminService){
