...
export class TransactionFournisseurListAdminComponent extends AbstractListController<TransactionFournisseurDto, TransactionFournisseurCriteria, TransactionFournisseurAdminService>  implements OnInit {
    ...
    constructor( private transactionFournisseurService: TransactionFournisseurAdminService  , private typeTransactionService: TypeTransactionAdminService, private compteService: CompteAdminService, private etatTransactionService: EtatTransactionAdminService, private typeInstrumentService: TypeInstrumentAdminService) {
