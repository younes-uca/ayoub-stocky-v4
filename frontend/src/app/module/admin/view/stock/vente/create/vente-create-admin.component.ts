...
export class VenteCreateAdminComponent extends AbstractCreateController<VenteDto, VenteCriteria, VenteAdminService>  implements OnInit {
   ...
   private _validVenteMontantTtc = true;
    ...
    constructor( private venteService: VenteAdminService , private depotService: DepotAdminService, private venteItemService: VenteItemAdminService, private taxeService: TaxeAdminService, private etatAvoirVenteService: EtatAvoirVenteAdminService, private entrepriseSocieteService: EntrepriseSocieteAdminService, private produitService: ProduitAdminService, private avoirVenteService: AvoirVenteAdminService, private reglementVenteService: ReglementVenteAdminService, private modeReglementService: ModeReglementAdminService, private etatVenteService: EtatVenteAdminService, private clientService: ClientAdminService) {
        super(venteService);
    }
