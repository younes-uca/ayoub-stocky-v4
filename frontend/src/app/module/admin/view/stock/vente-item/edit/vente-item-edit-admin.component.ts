...
export class VenteItemEditAdminComponent extends AbstractEditController<VenteItemDto, VenteItemCriteria, VenteItemAdminService>   implements OnInit {
    ...
    constructor( private venteItemService: VenteItemAdminService , private depotService: DepotAdminService, private taxeService: TaxeAdminService, private produitService: ProduitAdminService, private venteService: VenteAdminService) {
