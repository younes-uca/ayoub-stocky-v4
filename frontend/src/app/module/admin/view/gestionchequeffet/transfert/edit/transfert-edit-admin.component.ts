...
export class TransfertEditAdminComponent extends AbstractEditController<TransfertDto, TransfertCriteria, TransfertAdminService>   implements OnInit {
    ...
    ngOnInit(): void {
        this.transfertItemsElement.fromDepot = new DepotDto();
        this.fromDepotService.findAll().subscribe((data) => this.fromDepots = data);
        this.transfertItemsElement.toDepot = new DepotDto();
        this.toDepotService.findAll().subscribe((data) => this.toDepots = data);
