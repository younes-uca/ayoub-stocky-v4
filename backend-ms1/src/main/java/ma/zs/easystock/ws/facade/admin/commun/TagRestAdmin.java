...
public class TagRestAdmin  extends AbstractController<Tag, TagDto, TagCriteria, TagAdminService, TagConverter> {
    ...
    public ResponseEntity<TagDto> findByLibelle(@PathVariable String libelle, String[] includes, String[] excludes) throws Exception {
        return super.findByReferenceEntity(new Tag(libelle), includes, excludes);
    }
