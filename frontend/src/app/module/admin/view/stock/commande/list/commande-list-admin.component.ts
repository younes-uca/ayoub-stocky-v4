...
export class CommandeListAdminComponent extends AbstractListController<CommandeDto, CommandeCriteria, CommandeAdminService>  implements OnInit {
    ...
    constructor( private commandeService: CommandeAdminService  , private etatCommandeService: EtatCommandeAdminService, private taxeService: TaxeAdminService, private produitService: ProduitAdminService, private clientService: ClientAdminService, private commandeItemService: CommandeItemAdminService) {
