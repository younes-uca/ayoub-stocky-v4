...
export class ReglementAvoirAchatListAdminComponent extends AbstractListController<ReglementAvoirAchatDto, ReglementAvoirAchatCriteria, ReglementAvoirAchatAdminService>  implements OnInit {
    ...
    constructor( private reglementAvoirAchatService: ReglementAvoirAchatAdminService  , private achatService: AchatAdminService, private avoirAchatService: AvoirAchatAdminService, private modeReglementService: ModeReglementAdminService) {
