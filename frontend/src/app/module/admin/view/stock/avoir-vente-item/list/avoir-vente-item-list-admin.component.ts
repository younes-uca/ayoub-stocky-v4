...
export class AvoirVenteItemListAdminComponent extends AbstractListController<AvoirVenteItemDto, AvoirVenteItemCriteria, AvoirVenteItemAdminService>  implements OnInit {
    ...
    constructor( private avoirVenteItemService: AvoirVenteItemAdminService  , private depotService: DepotAdminService, private taxeService: TaxeAdminService, private produitService: ProduitAdminService, private avoirVenteService: AvoirVenteAdminService) {
