...
export class DevisCreateAdminComponent extends AbstractCreateController<DevisDto, DevisCriteria, DevisAdminService>  implements OnInit {
   ...
   private _validDevisMontantTtc = true;
    ...
    constructor( private devisService: DevisAdminService , private taxeService: TaxeAdminService, private produitService: ProduitAdminService, private devisItemService: DevisItemAdminService, private clientService: ClientAdminService) {
        super(devisService);
    }
